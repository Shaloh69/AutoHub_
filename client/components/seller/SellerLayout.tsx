// ==========================================
// components/seller/SellerLayout.tsx - Seller Sidebar Layout
// ==========================================
...
import {
  LayoutDashboard, Plus, Car, MessageCircle, CreditCard,
  Package, Settings, LogOut, Menu, X, Bell, Home, Calendar
} from 'lucide-react';
        ...
        <nav className="p-3 space-y-2 flex-1 overflow-y-auto">
          ...
          {sidebarOpen && (
            <div className="pt-4 mt-4 border-t border-gray-700">
              ...
              >
                <Car size={18} />
                <span className="text-sm">Browse Cars</span>
              </Link>
            </div>
          )}
        </nav>
